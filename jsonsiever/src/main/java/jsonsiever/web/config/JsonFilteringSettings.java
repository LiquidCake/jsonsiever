...
package jsonsiever.web.config;

import com.fasterxml.jackson.databind.JsonNode;
import jakarta.annotation.PostConstruct;
import jsonsiever.web.JsonFilteringUtils;
...
/**
 * Settings file should be put in classpath under name set in @link jsonsiever.web.config.JsonFilteringSettings#JSON_FILTERS_CONFIG_FILE}
 * <br>
 ...
 * you would use filter pattern {"name": 1}. More details on filter patterns in {@link jsonsiever.core.JsonFilteringService}
 * */
@Component
